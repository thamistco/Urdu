...
export const SENTENCES: Sentence[] = [
  ...
  { id: 's-157', words: ['یہ', 'ہمارا', 'کمرہ', 'ہے'], roman: 'ye hamaara kamra hai', meaning: 'This is our room', level: 'beginner', concept: 'g-possess' },
  { id: 's-158', words: ['وہ', 'میری', 'کتاب', 'ہے'], roman: 'wo meri kitaab hai', meaning: 'That is my book', level: 'beginner', concept: 'g-possess' },
  { id: 's-159', words: ['میں', 'استاد', 'ہوں'], roman: 'main ustaad hoon', meaning: 'I am a teacher', level: 'beginner', concept: 'g-to-be' },
  { id: 's-160', words: ['تم', 'اچھے', 'ہو'], roman: 'tum achhe ho', meaning: 'You are good', level: 'beginner', concept: 'g-to-be' },
  { id: 's-161', words: ['ہم', 'بھائی', 'ہیں'], roman: 'ham bhai hain', meaning: 'We are brothers', level: 'beginner', concept: 'g-to-be' },
  ...
  { id: 's-169', words: ['تم', 'وہاں', 'ہو'], roman: 'tum wahaañ ho', meaning: 'You are there', level: 'beginner', concept: 'g-pronouns' },
  { id: 's-170', words: ['آپ', 'بہت', 'اچھے', 'ہیں'], roman: 'aap bahut achhe hain', meaning: 'You are very good', level: 'beginner', concept: 'g-pronouns' },
  { id: 's-171', words: ['یہ', 'پھل', 'میٹھا', 'ہے'], roman: 'ye phal meeṭha hai', meaning: 'This fruit is sweet', level: 'beginner' },
  { id: 's-172', words: ['آسمان', 'صاف', 'ہے'], roman: 'aasmaan saaf hai', meaning: 'The sky is clear', level: 'beginner' },
  { id: 's-173', words: ['میری', 'ماں', 'مہربان', 'ہیں'], roman: 'meri maañ meherbaan hain', meaning: 'My mother is kind', level: 'beginner', concept: 'g-possess' },
  { id: 's-174', words: ['وہ', 'بچہ', 'خوش', 'ہے'], roman: 'wo bachcha khush hai', meaning: 'That child is happy', level: 'beginner', concept: 'g-pronouns' },
  { id: 's-175', words: ['میرا', 'کمرہ', 'چھوٹا', 'ہے'], roman: 'mera kamra chhoṭa hai', meaning: 'My room is small', level: 'beginner', concept: 'g-possess' },
  { id: 's-176', words: ['یہ', 'سوال', 'آسان', 'ہے'], roman: 'ye sawaal aasaan hai', meaning: 'This question is easy', level: 'beginner' },
  { id: 's-177', words: ['وہ', 'کام', 'مشکل', 'ہے'], roman: 'wo kaam mushkil hai', meaning: 'That work is difficult', level: 'beginner' },
  { id: 's-178', words: ['ہم', 'سب', 'ایک', 'ساتھ', 'ہیں'], roman: 'ham sab ek saath hain', meaning: 'We are all together', level: 'beginner', concept: 'g-pronouns' },
  { id: 's-179', words: ['تم', 'کہاں', 'ہو'], roman: 'tum kahaañ ho', meaning: 'Where are you?', level: 'beginner', concept: 'g-questions' },
  { id: 's-180', words: ['یہ', 'کس', 'کی', 'کتاب', 'ہے'], roman: 'ye kis ki kitaab hai', meaning: 'Whose book is this?', level: 'beginner', concept: 'g-questions' },
  { id: 's-181', words: ['میرا', 'نام', 'احمد', 'ہے'], roman: 'mera naam Ahmed hai', meaning: 'My name is Ahmed', level: 'beginner', concept: 'g-possess' },
  // ---- a third pass: postpositions, negation, questions, conjunctions ----
  { id: 's-182', words: ['کتاب', 'الماری', 'میں', 'ہے'], roman: 'kitaab almaari meñ hai', meaning: 'The book is in the cupboard', level: 'elementary', concept: 'g-postpositions' },
  ...
  { id: 's-190', words: ['میں', 'نے', 'کچھ', 'نہیں', 'کہا'], roman: 'main ne kuchh nahiñ kaha', meaning: 'I said nothing', level: 'elementary', concept: 'g-negation' },
  { id: 's-191', words: ['وہ', 'کیوں', 'رو', 'رہا', 'ہے'], roman: 'wo kyuñ ro raha hai', meaning: 'Why is he crying?', level: 'elementary', concept: 'g-questions' },
  ...
  { id: 's-199', words: ['میں', 'نے', 'لڑکیوں', 'سے', 'بات', 'کی'], roman: 'main ne laṛkiyoñ se baat ki', meaning: 'I spoke with the girls', level: 'elementary', concept: 'g-oblique' },
  { id: 's-200', words: ['یہ', 'راستہ', 'بازار', 'تک', 'جاتا', 'ہے'], roman: 'ye raasta bazaar tak jaata hai', meaning: 'This road goes to the market', level: 'elementary', concept: 'g-postpositions' },
  { id: 's-201', words: ['مجھے', 'اسکول', 'جانا', 'ہے'], roman: 'mujhe iskool jaana hai', meaning: 'I have to go to school', level: 'elementary' },
  { id: 's-202', words: ['آج', 'موسم', 'خراب', 'ہے'], roman: 'aaj mausam kharaab hai', meaning: 'The weather is bad today', level: 'elementary' },
  { id: 's-203', words: ['میرے', 'والدین', 'شہر', 'میں', 'رہتے', 'ہیں'], roman: 'mere waalidain shehar meñ rehte hain', meaning: 'My parents live in the city', level: 'elementary', concept: 'g-postpositions' },
  { id: 's-204', words: ['وہ', 'کتاب', 'پڑھنا', 'چاہتی', 'ہے'], roman: 'wo kitaab paṛhna chaahti hai', meaning: 'She wants to read a book', level: 'elementary' },
  { id: 's-205', words: ['کیا', 'تمہیں', 'یہ', 'پسند', 'ہے'], roman: 'kya tumheñ ye pasand hai', meaning: 'Do you like this?', level: 'elementary', concept: 'g-questions' },
  { id: 's-206', words: ['ہمیں', 'سچ', 'بتاؤ'], roman: 'hameñ sach bataao', meaning: 'Tell us the truth', level: 'elementary', concept: 'g-oblique' },
  // ---- a third pass: tenses, ability, obligation, comparison ----
  { id: 's-207', words: ['وہ', 'ہر', 'ہفتے', 'خط', 'لکھتا', 'ہے'], roman: 'wo har hafte khat likhta hai', meaning: 'He writes a letter every week', level: 'intermediate', concept: 'g-present' },
  ...
  { id: 's-215', words: ['مجھے', 'کہانیاں', 'پسند', 'ہیں'], roman: 'mujhe kahaaniyaañ pasand hain', meaning: 'I like stories', level: 'intermediate', concept: 'g-dative' },
  { id: 's-216', words: ['اسے', 'اردو', 'سمجھ', 'آتی', 'ہے'], roman: 'use urdu samajh aati hai', meaning: 'She understands Urdu', level: 'intermediate', concept: 'g-dative' },
  { id: 's-217', words: ['ہمیں', 'مدد', 'کی', 'ضرورت', 'ہے'], roman: 'hameñ madad ki zaroorat hai', meaning: 'We need help', level: 'intermediate', concept: 'g-dative' },
  { id: 's-218', words: ['کیا', 'تم', 'گاڑی', 'چلا', 'سکتے', 'ہو'], roman: 'kya tum gaaṛi chala sakte ho', meaning: 'Can you drive a car?', level: 'intermediate', concept: 'g-ability' },
  { id: 's-219', words: ['وہ', 'تیز', 'دوڑ', 'سکتا', 'ہے'], roman: 'wo tez dauṛ sakta hai', meaning: 'He can run fast', level: 'intermediate', concept: 'g-ability' },
  ...
  { id: 's-227', words: ['میں', 'نے', 'آج', 'اخبار', 'نہیں', 'پڑھا'], roman: 'main ne aaj akhbaar nahiñ paṛha', meaning: 'I did not read the newspaper today', level: 'intermediate', concept: 'g-past' },
  { id: 's-228', words: ['ہم', 'ہر', 'سال', 'عید', 'مناتے', 'ہیں'], roman: 'ham har saal Eid manaate hain', meaning: 'We celebrate Eid every year', level: 'intermediate', concept: 'g-present' },
  { id: 's-229', words: ['مجھے', 'موسیقی', 'سننا', 'اچھا', 'لگتا', 'ہے'], roman: 'mujhe mausiqi sunna achha lagta hai', meaning: 'I like listening to music', level: 'intermediate', concept: 'g-dative' },
  { id: 's-230', words: ['وہ', 'اپنی', 'زبان', 'میں', 'بات', 'کرتا', 'ہے'], roman: 'wo apni zabaan meñ baat karta hai', meaning: 'He speaks in his own language', level: 'intermediate' },
  ...
  { id: 's-237', words: ['دروازہ', 'کھولا', 'جا', 'رہا', 'ہے'], roman: 'darwaaza khola ja raha hai', meaning: 'The door is being opened', level: 'advanced', concept: 'g-passive' },
  { id: 's-238', words: ['استاد', 'نے', 'بچوں', 'کو', 'سبق', 'پڑھایا'], roman: 'ustaad ne bachchoñ ko sabaq paṛhaaya', meaning: 'The teacher taught the children a lesson', level: 'advanced', concept: 'g-causative' },
  ...
  { id: 's-246', words: ['کاش', 'میں', 'وہاں', 'ہوتا'], roman: 'kaash main wahaañ hota', meaning: 'I wish I had been there', level: 'advanced', concept: 'g-subjunctive' },
  { id: 's-247', words: ['جو', 'محنت', 'کرتا', 'ہے', 'وہ', 'کامیاب', 'ہوتا', 'ہے'], roman: 'jo mehnat karta hai wo kaamyaab hota hai', meaning: 'The one who works hard becomes successful', level: 'advanced', concept: 'g-relative' },
  { id: 's-248', words: ['جس', 'نے', 'سچ', 'بولا', 'اسے', 'سب', 'نے', 'مانا'], roman: 'jis ne sach bola use sab ne maana', meaning: 'Whoever spoke the truth, everyone believed', level: 'advanced', concept: 'g-relative' },
  { id: 's-249', words: ['جہاں', 'محبت', 'ہے', 'وہاں', 'سکون', 'ہے'], roman: 'jahaañ mohabbat hai wahaañ sukoon hai', meaning: 'Where there is love, there is peace', level: 'advanced', concept: 'g-relative' },
  { id: 's-250', words: ['ذرا', 'دروازہ', 'بند', 'کیجیے'], roman: 'zara darwaaza band keejiye', meaning: 'Please close the door', level: 'advanced', concept: 'g-imperative' },
  { id: 's-251', words: ['ذرا', 'یہاں', 'آئیے'], roman: 'zara yahaañ aaiye', meaning: 'Please come here', level: 'advanced', concept: 'g-imperative' },
  { id: 's-252', words: ['خاموش', 'رہیے'], roman: 'khaamosh rahiye', meaning: 'Please stay quiet', level: 'advanced', concept: 'g-imperative' },
  { id: 's-253', words: ['مجھے', 'امید', 'ہے', 'کہ', 'سب', 'خیریت', 'سے', 'ہیں'], roman: 'mujhe umeed hai ke sab khairiyat se hain', meaning: 'I hope everyone is well', level: 'advanced' },
  { id: 's-254', words: ['علم', 'انسان', 'کی', 'سب', 'سے', 'بڑی', 'دولت', 'ہے'], roman: 'ilm insaan ki sab se baṛi daulat hai', meaning: 'Knowledge is a person\'s greatest wealth', level: 'advanced' },
  { id: 's-255', words: ['وقت', 'کبھی', 'واپس', 'نہیں', 'آتا'], roman: 'waqt kabhi waapas nahiñ aata', meaning: 'Time never comes back', level: 'advanced' },
  { id: 's-256', words: ['سچائی', 'ہمیشہ', 'جیتتی', 'ہے'], roman: 'sachaai hamesha jeetti hai', meaning: 'Truth always wins', level: 'advanced' },
];
