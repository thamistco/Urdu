...
const PLANNED_UNITS: Unit[] = [
  ...
  },
  {
    ...
    level: 'elementary',
    color: BLUE,
    title: 'Unit 16 · Around the House',
    subtitle: 'The kitchen, the bathroom, clothing, what size things are, and how to say no',
    lessons: [
  ...
  },
  {
    ...
    level: 'intermediate',
    color: ROSE,
    title: 'Unit 22 · Money, Markets & Meals',
    subtitle: 'Money and shopping, a restaurant, and grains and staples',
    lessons: [
