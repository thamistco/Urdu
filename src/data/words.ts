...
const CORE_WORDS: Word[] = [
  ...
  { id: 'w-mehrbani', urdu: 'مہربانی', roman: 'meherbaani', meaning: 'kindness / please', emoji: '🙏', topic: 'greetings' },
  ...
  { id: 'w-pait', urdu: 'پیٹ', roman: 'peṭ', meaning: 'stomach / belly', emoji: '🫃', topic: 'body', pronounce: 'پَیٹ' },
