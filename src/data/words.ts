...
const CORE_WORDS: Word[] = [
  ...
  { id: 'w-zaroorat2', urdu: 'ضرورت', roman: 'zaroorat', meaning: 'need / necessity', emoji: '❗', topic: 'first-words' },
  ...
  { id: 'w-inshaallah', urdu: 'ان شاء اللہ', roman: 'insha-allah', meaning: 'God willing', emoji: '🤲', topic: 'greetings' },
  ...
  { id: 'w-pait', urdu: 'پیٹ', roman: 'pait', meaning: 'stomach / belly', emoji: '🫃', topic: 'body' },
  ...
  { id: 'w-bhediya', urdu: 'بھیڑیا', roman: 'bhediya', meaning: 'wolf', emoji: '🐺', topic: 'animals' },
  ...
  { id: 'w-shimlamirch', urdu: 'شملہ مرچ', roman: 'shimla mirch', meaning: 'bell pepper', emoji: '🫑', topic: 'vegetables' },
  ...
  { id: 'w-jaib', urdu: 'جیب', roman: 'jaib', meaning: 'pocket', emoji: '👖', topic: 'clothing' },
  ...
  { id: 'w-takhta-siyah', urdu: 'تختہ سیاہ', roman: 'takhta-siyaah', meaning: 'blackboard', emoji: '⬛', topic: 'school' },
  ...
  { id: 'w-principal', urdu: 'پرنسپل', roman: 'prinsipal', meaning: 'principal / headteacher', emoji: '🧑‍💼', topic: 'school' },
  ...
  { id: 'w-pal', urdu: 'پل', roman: 'pal', meaning: 'instant / moment', emoji: '⏱️', topic: 'time' },
  ...
  { id: 'w-boondabaandi2', urdu: 'بوندا باندی', roman: 'boonda-baañdi', meaning: 'drizzle', emoji: '🌦️', topic: 'weather' },
  { id: 'w-shadeed2', urdu: 'شدید', roman: 'shadeed', meaning: 'severe', emoji: '⚠️', topic: 'weather' },
  { id: 'w-khushgawaar2', urdu: 'خوشگوار', roman: 'khushgawaar', meaning: 'pleasant (weather)', emoji: '🌤️', topic: 'weather' },
  ...
  { id: 'w-helicopter', urdu: 'ہیلی کاپٹر', roman: 'heli-kaapṭar', meaning: 'helicopter', emoji: '🚁', topic: 'transport' },
  { id: 'w-nashist', urdu: 'نشست', roman: 'nashist', meaning: 'seat', emoji: '💺', topic: 'transport' },
  ...
  { id: 'w-hoshiyaar', urdu: 'ہوشیار', roman: 'hoshiyaar', meaning: 'clever / smart', emoji: '🧠', topic: 'adjectives' },
  ...
  { id: 'w-sharminda', urdu: 'شرمندہ', roman: 'sharminda', meaning: 'embarrassed / ashamed', emoji: '😳', topic: 'feelings' },
  ...
  { id: 'w-tasalli', urdu: 'تسلی', roman: 'tasalli', meaning: 'reassurance / consolation', emoji: '🤗', topic: 'feelings' },
  ...
  { id: 'w-chirchira', urdu: 'چڑچڑا', roman: 'chiṛchiṛa', meaning: 'irritable / grumpy', emoji: '😤', topic: 'feelings' },
  ...
  { id: 'w-qasai', urdu: 'قصائی', roman: 'qasaai', meaning: 'butcher', emoji: '🥩', topic: 'jobs' },
  ...
  { id: 'w-naqad', urdu: 'نقد', roman: 'naqad', meaning: 'cash', emoji: '💵', topic: 'money' },
  ...
  { id: 'w-kastam2', urdu: 'کسٹم', roman: 'kastam', meaning: 'customs', emoji: '🛃', topic: 'travel' },
  ...
  { id: 'w-waapsitikat2', urdu: 'واپسی ٹکٹ', roman: 'waapsi ṭikaṭ', meaning: 'return ticket', emoji: '🎫', topic: 'travel' },
  ...
  { id: 'w-shahri', urdu: 'شہری', roman: 'shahri', meaning: 'citizen', emoji: '🪪', topic: 'city' },
  ...
  { id: 'w-yaadkarna', urdu: 'یاد کرنا', roman: 'yaad karna', meaning: 'to remember / recall', emoji: '🧠', topic: 'verbs2' },
  ...
  { id: 'w-sambhalna', urdu: 'سنبھالنا', roman: 'sambhalna', meaning: 'to manage / take care', emoji: '🤲', topic: 'verbs2' },
  ...
  { id: 'w-network2', urdu: 'نیٹ ورک', roman: 'neṭ-wark', meaning: 'network', emoji: '📶', topic: 'tech' },
  { id: 'w-raabta2', urdu: 'رابطہ', roman: 'raabta', meaning: 'contact / connection', emoji: '🔗', topic: 'tech' },
  { id: 'w-paighaamrasaani2', urdu: 'پیغام رسانی', roman: 'paighaam-rasaani', meaning: 'messaging', emoji: '💬', topic: 'tech' },
  ...
  { id: 'w-lehr2', urdu: 'لہر', roman: 'lehr', meaning: 'wave', emoji: '🌊', topic: 'nature2' },
